...
# Accord Protocol Template: articles-of-association-uk
...
```
cicero parse --template ./articles-of-association-uk/ --dsl ./articles-of-association-uk/sample.txt
...
data.json:
{
   "$class": "org.legalschema.articles.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./articles-of-association-uk/ --dsl ./articles-of-association-uk/sample.txt --data ./articles-of-association-uk/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.legalschema.articles.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.legalschema.articles.Response",
